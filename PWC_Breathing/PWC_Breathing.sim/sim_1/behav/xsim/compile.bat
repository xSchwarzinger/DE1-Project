...
REM
REM Generated by Vivado on Wed Apr 08 13:35:32 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_up_down_counter_vhdl.prj"
call xvhdl  --incr --relax -prj tb_up_down_counter_vhdl.prj -log xvhdl.log
